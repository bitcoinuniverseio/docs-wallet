...
- **Protocol actions depend on release evidence.** An action whose end-to-end evidence is not current in your release is hidden or shown as unavailable, with the reason, even though the code exists. This is deliberate; see [the release rule](../assets-and-protocols/overview.md#the-release-rule).
